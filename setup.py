...
setup(
  name = 'invoicing-pdf-testing-and-learning',         #* Your package will have this name
  ...
  author = 'Andrii',                   # Your name
  author_email = 'your.email@example.com',  # Your email
  url = 'https://pakitowka@bitbucket.org/pakitowka/python-package.git',              # Homepage of your library (e.g. github or your website)
